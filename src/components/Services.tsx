    ...
    <section id="services" className="relative section-padding overflow-hidden bg-white">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16">
          ...
          <a href="#contact" className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-navy-950/5 border border-navy-950/10 text-navy-950 text-xs font-semibold hover:border-gold/40 transition self-start reveal-up">
            Talk to an expert
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-5">
          {services.map((s, i) => (
            <div key={s.title}
              className="service-card group glass-light rounded-2xl p-6 lg:p-7 border border-navy-950/10 card-lift cursor-pointer reveal-up"
            ...
            >
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="text-[9px] uppercase tracking-[0.2em] text-navy-950/50 px-2 py-1 rounded-full border border-navy-950/10">{s.tag}</span>
              </div>
